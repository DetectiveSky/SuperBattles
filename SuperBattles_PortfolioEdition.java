...
public class SuperBattles_PortfolioEdition implements MouseListener
{
   Card[] deck;
   ...
   public SuperBattles_PortfolioEdition ()
   ...
   //frame is the title screen, s2 the settings, and s1 the game.
      ...
      try{
      music=Applet.newAudioClip(new URL("https://www.youtube.com/watch?v=dv6pJ2D_Sek"));
      music.loop();
   ...
   {//Main doesn't do much other than call the constructor.
      new SuperBattles_PortfolioEdition();
   }
